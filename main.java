...
public class main {     
    ...
    //TODO:build the hash table and insert keys using the insertKeyArray function.
     ...
     public void insertProbeTest2() {
         ...
         int jumps = p.insertKeyArray(keyArray);
         // 2 collisions!
         // 4 has hash value 2 (calculated by probe) 
         // 7 has hash value 1 --> collision with 1 (total collision = 1)
         // goes to next spot --> collision with 4 (total collision = 4)
         // goes to next spot (success! total collisions is 2)        
         if  (jumps== 2){
         ...
         /*
         int hash1 = p.probe(2,0);
         System.out.println(hash1);
         int hash2 = p.probe(7, 0);
         System.out.println(hash2); */
     }
     
   // testing unsuccessful probe insertion
     /**
 ...
 /**
     ...
     public void removeProbeTest3(){
             ...
             // I think their test with num jumps might be wrong?
