...
public class Chaining {
    ...
    public int insertKey(int key){
    	...
    	// finding bucket location with hash function
        int index = chain(key);
        ArrayList<Integer> newList = Table.get(index);
        
        // collision num is num elements before insertion
        int collisions = newList.size();
